...
//
//	CPen newPen;
//	newPen.CreatePen(PS_SOLID, 0.5, RGB(255, 0, 0));
...
//		}
//
//#pragma region 테스트 : 조명 방향에 따른 밝기값 미리 지정
//		float brightness1[4][1] = {};
//		float brightness2[4][1] = {};
//	#pragma region 0번째 점 기준 3개의 면
//		brightness1[0][0] = -cub[0].x + cub[1].x; brightness1[1][0] = -cub[0].y + cub[1].y; brightness1[2][0] = -cub[0].z + cub[1].z;
//		brightness2[0][0] = -cub[1].x + cub[3].x; brightness2[1][0] = -cub[1].y + cub[3].y; brightness2[2][0] = -cub[1].z + cub[3].z;
//
//		float brightNorm[3][1] = {};
//		float* bPtr = CrossProduct(brightness1, brightness2);
//		int bCount = 0;
//		for (int i = 0; i < 3; i++)
//		{
...
//			bCount++;
//		}
//		float dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[0].lightStrength1 = dotProd;
//		//
//		brightness1[0][0] = -cub[0].x + cub[3].x; brightness1[1][0] = -cub[0].y + cub[3].y; brightness1[2][0] = -cub[0].z + cub[3].z;
//		brightness2[0][0] = -cub[3].x + cub[4].x; brightness2[1][0] = -cub[3].y + cub[4].y; brightness2[2][0] = -cub[3].z + cub[4].z;
//
...
//			bCount++;
//		}
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);;
//		if (dotProd < 0) dotProd = 0;
//		cub[0].lightStrength2 = dotProd;
//		//
//		brightness1[0][0] = -cub[0].x + cub[4].x; brightness1[1][0] = -cub[0].y + cub[4].y; brightness1[2][0] = -cub[0].z + cub[4].z;
//		brightness2[0][0] = -cub[4].x + cub[1].x; brightness2[1][0] = -cub[4].y + cub[1].y; brightness2[2][0] = -cub[4].z + cub[1].z;
//
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
//		for (int i = 0; i < 3; i++)
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[0].lightStrength3 = dotProd;
//	#pragma endregion
//	#pragma region 7번 점 기준 3개의 면
//		brightness1[0][0] = -cub[7].x + cub[3].x; brightness1[1][0] = -cub[7].y + cub[3].y; brightness1[2][0] = -cub[7].z + cub[3].z;
//		brightness2[0][0] = -cub[3].x + cub[6].x; brightness2[1][0] = -cub[3].y + cub[6].y; brightness2[2][0] = -cub[3].z + cub[6].z;
//
//		brightNorm[3][1] = {};
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[7].lightStrength1 = dotProd;
//		//
//		brightness1[0][0] = -cub[7].x + cub[4].x; brightness1[1][0] = -cub[7].y + cub[4].y; brightness1[2][0] = -cub[7].z + cub[4].z;
//		brightness2[0][0] = -cub[4].x + cub[3].x; brightness2[1][0] = -cub[4].y + cub[3].y; brightness2[2][0] = -cub[4].z + cub[3].z;
//
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
//		for (int i = 0; i < 3; i++)
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[7].lightStrength2 = dotProd;
//		//
//		brightness1[0][0] = -cub[7].x + cub[6].x; brightness1[1][0] = -cub[7].y + cub[6].y; brightness1[2][0] = -cub[7].z + cub[6].z;
//		brightness2[0][0] = -cub[6].x + cub[4].x; brightness2[1][0] = -cub[6].y + cub[4].y; brightness2[2][0] = -cub[6].z + cub[4].z;
//
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
//		for (int i = 0; i < 3; i++)
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[7].lightStrength3 = dotProd;
//	#pragma endregion
//	#pragma region 2번 점 기준 3개의 면
//		brightness1[0][0] = -cub[2].x + cub[1].x; brightness1[1][0] = -cub[2].y + cub[1].y; brightness1[2][0] = -cub[2].z + cub[1].z;
//		brightness2[0][0] = -cub[1].x + cub[6].x; brightness2[1][0] = -cub[1].y + cub[6].y; brightness2[2][0] = -cub[1].z + cub[6].z;
//
//		brightNorm[3][1] = {};
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[2].lightStrength1 = dotProd;
//		//
//		brightness1[0][0] = -cub[2].x + cub[3].x; brightness1[1][0] = -cub[2].y + cub[3].y; brightness1[2][0] = -cub[2].z + cub[3].z;
//		brightness2[0][0] = -cub[3].x + cub[1].x; brightness2[1][0] = -cub[3].y + cub[1].y; brightness2[2][0] = -cub[3].z + cub[1].z;
//
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
//		for (int i = 0; i < 3; i++)
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[2].lightStrength2 = dotProd;
//		//
//		brightness1[0][0] = -cub[2].x + cub[6].x; brightness1[1][0] = -cub[2].y + cub[6].y; brightness1[2][0] = -cub[2].z + cub[6].z;
//		brightness2[0][0] = -cub[6].x + cub[3].x; brightness2[1][0] = -cub[6].y + cub[3].y; brightness2[2][0] = -cub[6].z + cub[3].z;
//
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
//		for (int i = 0; i < 3; i++)
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[2].lightStrength3 = dotProd;
//	#pragma endregion
//	#pragma region 5번 점 기준 3개의 면
//		brightness1[0][0] = -cub[5].x + cub[1].x; brightness1[1][0] = -cub[5].y + cub[1].y; brightness1[2][0] = -cub[5].z + cub[1].z;
//		brightness2[0][0] = -cub[1].x + cub[4].x; brightness2[1][0] = -cub[1].y + cub[4].y; brightness2[2][0] = -cub[1].z + cub[4].z;
//
//		brightNorm[3][1] = {};
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[5].lightStrength1 = dotProd;
//		//
//		brightness1[0][0] = -cub[5].x + cub[4].x; brightness1[1][0] = -cub[5].y + cub[4].y; brightness1[2][0] = -cub[5].z + cub[4].z;
//		brightness2[0][0] = -cub[4].x + cub[6].x; brightness2[1][0] = -cub[4].y + cub[6].y; brightness2[2][0] = -cub[4].z + cub[6].z;
//
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
//		for (int i = 0; i < 3; i++)
...
//		dotProd = (-1) * DotProduct(brightNorm, lightDirection) / vectorLength(brightNorm);
//		if (dotProd < 0) dotProd = 0;
//		cub[5].lightStrength2 = dotProd;
//		//
//		brightness1[0][0] = -cub[5].x + cub[6].x; brightness1[1][0] = -cub[5].y + cub[6].y; brightness1[2][0] = -cub[5].z + cub[6].z;
//		brightness2[0][0] = -cub[6].x + cub[1].x; brightness2[1][0] = -cub[6].y + cub[1].y; brightness2[2][0] = -cub[6].z + cub[1].z;
//
//		bPtr = CrossProduct(brightness1, brightness2);
//		bCount = 0;
//		for (int i = 0; i < 3; i++)
...
//		//////////////////////////////////////////////////////
//		/*CString str = _T("");
//		str.Format(_T("%f"), originInView[2][0]);
//		AfxMessageBox(str);*/
//		// sphere 각 점들을 투영 시킴
//		if (projNum == 0)
//		{
...
//			else
//			{
//				tempVertex[0][0] = cub[i].x * (width / height) * 100;
//				tempVertex[1][0] = cub[i].y * 100;
...
//				CBrush num0Brush;
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[0].lightStrength2), 0));
//				CBrush* prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[0].lightStrength3), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[0].x), ToScreenY(rect.Height(), rect.top, cub[0].y));
//				memDC.LineTo(ToScreenX(rect.Width(), rect.left, cub[4].x), ToScreenY(rect.Height(), rect.top, cub[4].y));
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[0].lightStrength1), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[0].x), ToScreenY(rect.Height(), rect.top, cub[0].y));
//				memDC.LineTo(ToScreenX(rect.Width(), rect.left, cub[3].x), ToScreenY(rect.Height(), rect.top, cub[3].y));
...
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[7].lightStrength2), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[7].lightStrength3), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[7].x), ToScreenY(rect.Height(), rect.top, cub[7].y));
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[7].lightStrength1), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[7].x), ToScreenY(rect.Height(), rect.top, cub[7].y));
//				memDC.LineTo(ToScreenX(rect.Width(), rect.left, cub[3].x), ToScreenY(rect.Height(), rect.top, cub[3].y));
...
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[2].lightStrength1), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[2].lightStrength2), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[2].x), ToScreenY(rect.Height(), rect.top, cub[2].y));
//				memDC.LineTo(ToScreenX(rect.Width(), rect.left, cub[1].x), ToScreenY(rect.Height(), rect.top, cub[1].y));
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[2].lightStrength3), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[2].x), ToScreenY(rect.Height(), rect.top, cub[2].y));
//				memDC.LineTo(ToScreenX(rect.Width(), rect.left, cub[3].x), ToScreenY(rect.Height(), rect.top, cub[3].y));
...
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[5].lightStrength3), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[5].lightStrength1), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[5].x), ToScreenY(rect.Height(), rect.top, cub[5].y));
//				memDC.LineTo(ToScreenX(rect.Width(), rect.left, cub[1].x), ToScreenY(rect.Height(), rect.top, cub[1].y));
...
//				num0Brush.DeleteObject();
//
//				num0Brush.CreateSolidBrush(RGB(0, (int)round(255 * cub[5].lightStrength2), 0));
//				prevBrush = memDC.SelectObject(&num0Brush);
//				memDC.BeginPath();
//				memDC.MoveTo(ToScreenX(rect.Width(), rect.left, cub[5].x), ToScreenY(rect.Height(), rect.top, cub[5].y));
//				memDC.LineTo(ToScreenX(rect.Width(), rect.left, cub[6].x), ToScreenY(rect.Height(), rect.top, cub[6].y));
...
//			else
//			{
//				tempVertex[0][0] = sph[i].x *(width / height) * 100;
//				tempVertex[1][0] = sph[i].y * 100;
...
//	//	}//////////////////////////
//	//	// 뷰 변환
//	//	float lightSphere[4][1] = {};
//	//	float* lightPtr;
//	//	int lightCount = 0;
//	//	for (int i = 0; i < 230; i++)
//	//	{
//	//		lightSphere[0][0] = sph[i].x; lightSphere[1][0] = sph[i].y; lightSphere[2][0] = sph[i].z; lightSphere[3][0] = 1;
//	//		lightPtr = MatrixMulti(view, lightSphere);
//	//		lightCount = 0;
//	//		for (int j = 0; j < 4; j++)
//	//		{
//	//			lightSphere[j][0] = *(lightPtr + lightCount);
//	//			lightCount++;
//	//		}
//	//		sph[i].x = lightSphere[0][0]; sph[i].y = lightSphere[1][0]; sph[i].z = lightSphere[2][0];
//	//	}
//	//	/////////////////////////////
//	//	// 투영 변환
//	//	if (projNum == 0)
...
//	//		{
//	//			lightSphere[0][0] = sph[i].x; lightSphere[1][0] = sph[i].y; lightSphere[2][0] = sph[i].z; lightSphere[3][0] = 1;
//	//			lightPtr = MatrixMulti(proj, lightSphere);
//	//			lightCount = 0;
//	//			for (int j = 0; j < 4; j++)
//	//			{
//	//				lightSphere[j][0] = *(lightPtr + lightCount);
//	//				lightCount++;
//	//			}
//	//			sph[i].x = lightSphere[0][0] / lightSphere[2][0]; sph[i].y = lightSphere[1][0] / lightSphere[2][0]; sph[i].z = lightSphere[2][0];
//	//		}
//	//	}
//	//	else
//	//	{
...
//	//	/////////////////////////////
//	//	// 해당 도형 그리기 -> 하얀색
//	//	CBrush lightBrush(RGB(255, 255, 255));
//	//	CBrush* lightOldBrush = memDC.SelectObject(&lightBrush);
//	//	CPen lightPen;
//	//	lightPen.CreatePen(PS_SOLID, 1, RGB(255, 255, 255));
//	//	oldPen = memDC.SelectObject(&lightPen);
//	//	// 첫번째 메쉬
//	//	for (int i = 1; i < 13; i++)
//	//	{
//	//		memDC.BeginPath();
...
//	//	}
//	//	///////////////////
//	//	memDC.SelectObject(lightOldBrush);
...
//				isChecked = TRUE;
//				////////////////////
//				figure.moveX += camAxisY[0][0];
//				figure.moveY += camAxisY[1][0];
//				figure.moveZ += camAxisY[2][0];
//				////////////////////
//				break;
//			}
//			for (auto& figure : v_sphereFigure)
...
//				if (!figure.isClicked) continue;
//				isChecked = TRUE;
//				figure.moveX += camAxisX[0][0];
//				figure.moveY += camAxisX[1][0];
//				figure.moveZ += camAxisX[2][0];
//				break;
//			}
//			for (auto& figure : v_sphereFigure)
//			{
